...
set.seed(1)
obs1 <- data.frame(Time = c(rnorm(20, 100, 10), rnorm(20, 200, 50), rnorm(20, 500, 60), rnorm(20, 100, 50)), Group1 = rep(c("CAT", "DOG"), times = 40), Group2 = rep(c("A", "B", "C", "D"), each = 20))
set.seed(NULL)
fun_info(obs1)
...
fun_gg_boxplot(data1 = obs1, y = "Time", categ = c("Group1", "Group2"))
# Order matters
fun_gg_boxplot(data1 = obs1, y = "Time", categ = c("Group2", "Group1"))
### single class
fun_gg_boxplot(data1 = obs1[1:20, ], y = "Time", categ = "Group2")
fun_gg_boxplot(data1 = obs1[1:20, ], y = "Time", categ = c("Group1", "Group2"))

### Changing the order of the classes
# separate boxes
fun_gg_boxplot(data1 = obs1, y = "Time", categ = "Group1", categ.class.order = list(c("DOG", "CAT")))
# grouped boxes
fun_gg_boxplot(data1 = obs1, y = "Time", categ = c("Group1", "Group2"), categ.class.order = list(c("DOG", "CAT"), c("D", "C", "B", "A")))

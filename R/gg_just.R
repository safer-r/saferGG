...
gg_just <- function(
    ...
    tempo <- saferDev::arg_check(data = angle , class = "integer", length = 1, double.as.integer.allowed = TRUE, neg.values = TRUE, fun.name = function.name, safer_check = FALSE) ; base::eval(ee)

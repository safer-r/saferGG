...
load("C:/Users/gael/Documents/Git_projects/cute_little_R_functions/check/check_dataset.t25_20201108.RData") # recover the test list tl file
...
for(i0 in 1:2){
    ...
    res <- fun_test(
        ...
        val = list(
            L1 = if(i0 == 1){t25_20201108}else{"a"}, 
            L2 = if(i0 == 2){t25_20201108}else{"a"}, 
        ),
        thread.nb = NULL, 
        plot.fun = FALSE, 
        export = TRUE, 
